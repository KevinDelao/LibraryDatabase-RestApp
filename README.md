...
to show forms entries and data from the MySQL database. Thymeleaf MVC was chosen over JSP due to the simplicity of Thymeleaf at displaying class objects. For the backend Spring REST was used to easily communicate between Java and my local MySQL database. 
